...
<div class="otziv-old"><a href="%lnk%/otzivi/">Все отзывы о пленочном отоплении в %r%</a></div><span class="title-count"><?=$count?></span>
...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="otziv-block block" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		<?if($arItem["PREVIEW_PICTURE"]):?>
			...
			?>
			<a class="otz-scan fancy" href="%lnk%<?=$img['src']?>"><img src="<?=$img_mini['src']?>"/></a>
		<?endif?>
