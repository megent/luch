...
if (isset($_GET['PAGEN_1'])) {
	...
	$pagen_desc = "Реальные отзывы клиентов в %r% о инфракрасном отоплении";

	$title_new = "{$pagen_name} страница {$_GET['PAGEN_1']}, реальные отзывы о инфракрасном отоплении в %r%";
