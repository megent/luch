...
<footer class="footer">
	 <div class="footer-wrap">
		...
		<div class="foot-kont">
			...
			<div class="foot-adress">г.Тюмень, ул.Молодежная д.8, оф. 205 ( <a href="/kontakty/#cont-map">схема</a> )</div>
		</div>
		<div class="foot-cop">© 2013—<?=date("Y");?>, OOO «ОтоплениеРу». Сайт ни при каких условиях не является публичной офертой</div>
		 <div class="foot-wrap-get-form">
			 ...
			 <a href="/vopros-otvet/" class="lnk-vopros">Задать вопрос</a>
		 </div>
...
<?/*Блок с подключением скриптов и таблиц стилей CSS*/?>
	...
	<?$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH.'/js/jquery.1.8.1.min.js');?>
